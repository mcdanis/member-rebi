<?php 
    ...
    $customPixel = $sistem->eksekusiShow("select * from link_line where username='".$thisUsername."' and id_link='1' ")['custom_pixel'];
?>
<!DOCTYPE html>
<html lang="en-US">
    <head>
        ...
        <title>Jangan Merasa Sukses Bisnis Online Kalo belum pakai tools REBI | RemoteBisnis</title>
                                    ...
                                    <div class="elementor-widget-container">
                                        <ul class="elementor-icon-list-items">
                                            ...
                                            <li class="elementor-icon-list-item">
                                                <span class="elementor-icon-list-icon">
                                                <i aria-hidden="true" class="fas fa-check"></i>                </span>
                                                <span class="elementor-icon-list-text">900 Data Supplier dari berbagai jenis Niche Produk </span>
                                            </li>
                                            <li class="elementor-icon-list-item">
                                                <span class="elementor-icon-list-icon">
                                                <i aria-hidden="true" class="fas fa-check"></i>                </span>
                        ...
                        <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-661ff4b4" data-id="661ff4b4" data-element_type="column">
                            <div class="elementor-widget-wrap elementor-element-populated">
                                ...
                                <div class="elementor-element elementor-element-6ffba8ca elementor-widget elementor-widget-heading" data-id="6ffba8ca" data-element_type="widget" data-widget_type="heading.default">
                                    <div class="elementor-widget-container">
                                        <p class="elementor-heading-title elementor-size-default">inilah investasi terbaik Anda untuk membangun bisnis digital</p>
                                    </div>
                                </div>
