<?php 
    ...
    $customPixel = $sistem->eksekusiShow("select * from link_line where username='".$thisUsername."' and id_link='3' ")['custom_pixel'];
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Isi lengkap field dibawah ini :)</p>
    <p>Dapatkan Tips & Trik Bisnis Digital Secara Praktis Setiap Minggunya</p>
    ...
    <form action="setting/function/proses_daftar.php" method="post">
        ...
        <div class="radio text-center">
          ...
          ?>
            <label class="b red hide">
              <input type="radio" name="type_akun" value="b" checked> Full Akses
            </label>&nbsp;&nbsp;&nbsp;&nbsp;
          <?php endif ?>
          <label class="b hide">
            <input <?= $select; ?> type="radio" name="type_akun" value="t"> Gratisan dulu ah
          </label>
        </div>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <select name="tahu" class="form-control" required>
          ...
          <option value="Iklan di Game/Aplikasi">Youtube</option>
        </select>
      </div>
      <div class="form-group has-feedback">
